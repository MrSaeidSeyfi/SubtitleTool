...
# Video settings
FONT_SIZE_RATIO = float(get_env_setting("FONT_SIZE_RATIO", DEFAULT_FONT_SIZE_RATIO))
SUBTITLE_HEIGHT_RATIO = float(get_env_setting("SUBTITLE_HEIGHT_RATIO", DEFAULT_SUBTITLE_HEIGHT_RATIO))
